...
\begin{frame}[fragile]
    ...
    \begin{columns}
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                \item \textbf{Header file (.h):} defines the public interface of the class
                      \begin{itemize}
        ...
        \begin{column}{0.5\textwidth}
            ...
            \begin{itemize}
                \item \texttt{Circle.h} - interface of \texttt{Circle}
...
\end{lstlisting}
    ...
    \begin{itemize}
        ...
        \item Later inclusions: \texttt{TIME\_H} is already defined -> body is skipped.
    \end{itemize}
\end{frame}

% =========================================================
\section{OOP Examples}
\subsection{Example: Circle Class (Modular Version)}
        ...
        \begin{column}{0.5\textwidth}
            \begin{itemize}
                ...
                \item Typical private data members:
                      \begin{itemize}
                          \item \texttt{int hour;} (0-23)
                          \item \texttt{int minute;} (0-59)
                          \item \texttt{int second;} (0-59)
                      \end{itemize}
                \item Public operations (in \texttt{Time.h}):
                      \begin{itemize}
...
\begin{frame}{Point Class – Modeling 2D points}
    \begin{columns}[T]
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width=\linewidth]{images/point.png}
        \end{column}
        \begin{column}{0.55\textwidth}
            The \texttt{Point} class models 2D points with integer coordinates.
            \begin{itemize}
                \item Private data:
                      \begin{itemize}
...
% =========================================================
\subsection{Account Class}

\begin{frame}{Account Class – Bank account model}
    \begin{columns}[T]
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width=\linewidth]{images/account.png}
        \end{column}
        \begin{column}{0.55\textwidth}
            The \texttt{Account} class models a simple bank account.
            \begin{itemize}
                \item Private data:
                      \begin{itemize}
                ...
                \item Public operations:
                      ...
                      \end{itemize}
            \end{itemize}
            Big code: \textbf{\texttt{Account.h}}, \textbf{\texttt{Account.cpp}}, \textbf{\texttt{TestAccount.cpp}}.
        \end{column}
    \end{columns}
\end{frame}
...
\begin{frame}{Ball Class – Moving object}
    \begin{columns}[T]
        \begin{column}{0.4\textwidth}
            ...
            \centering
            \includegraphics[width=\linewidth]{images/ball.png}
        \end{column}
        \begin{column}{0.6\textwidth}
            A \texttt{Ball} class models a moving ball in 2D.
            \begin{itemize}
                \item Private data:
                      \begin{itemize}
                ...
                \item Public operations:
                      ...
                      \end{itemize}
            \end{itemize}
            Big code: \textbf{\texttt{Ball.h}}, \textbf{\texttt{Ball.cpp}}, \textbf{\texttt{TestBall.cpp}}%.
        \end{column}
    \end{columns}
\end{frame}

% =========================================================
\subsection{ Author \& Book Classes}
...
\begin{frame}{Author Class – Person who writes books}
    \begin{columns}[T]
        ...
        \end{column}
        \begin{column}{0.55\textwidth}
            \texttt{Author} represents a single author.
            \begin{itemize}
                \item Private data:
                      \begin{itemize}
...
\begin{frame}{Book Class – Has-a Author}
    \begin{columns}[T]
        \begin{column}{0.45\textwidth}
            \centering
            \includegraphics[width=\linewidth]{images/book.png}
        \end{column}
        \begin{column}{0.55\textwidth}
            \texttt{Book} models a book written by exactly one author.
            \begin{itemize}
                \item Private data:
                      \begin{itemize}
                          \item \texttt{string name;}
...
\begin{frame}{Aggregation: \texttt{Book} has-an \texttt{Author}}
    \begin{itemize}
        \item In the UML diagram, the \textit{hollow diamond} near \texttt{Book} means \textbf{aggregation} (a \emph{has-a} relationship).
        \item In code:
              \begin{itemize}
